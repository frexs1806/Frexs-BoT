...
module.exports.run = async (bot, message, args) => {
    ...
    const embed = new discord.MessageEmbed()
        ...
        .addField("Créateurs", `${message.guild.owner.user.username}#${message.guild.owner.user.discriminator}`, true)
        ...
        .addField("Levels de vérification", verifLevels[message.guild.verificationLevel], true)
